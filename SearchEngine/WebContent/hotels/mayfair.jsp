		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/mayfair.jpg" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >May Fair</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star2.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(JFK International Airport) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">The May Fair JFK Airport offers complimentary scheduled taxi service to the local subway station and a complimentary airport shuttle. Amenities include 24-hour business and fitness centers, and a lobby restaurant with high-speed Internet access. </tr>
					</table>
				...
				<td class="resultTD" align="center" style="width:300px; background: white;">
					...
					<font size=30   style="color:green;">$150</font> 
					/night
