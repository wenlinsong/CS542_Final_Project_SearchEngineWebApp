		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/union.jpg" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >Union</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star3.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(Brooklyn) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">Within walking distance of Williamsburg shops and restaurants, Union is 3 blocks from the subway and 6 blocks from Bedford Avenue's theaters and music venues. Times Square is 6 miles away.</tr>
					</table>
				...
				<td class="resultTD" align="center" style="width:300px; background: white;">
					...
					<font size=30   style="color:green;">$232</font> 
					/night
