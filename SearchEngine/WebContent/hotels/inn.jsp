...
<title>Inn at Time Square</title>
		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/inn.JPG" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >Inn</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star2.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(Time Squre) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">The New York Inn is a budget-friendly Midtown hotel, ideally situated just two blocks from Times Square and Broadway theaters!</tr>
					</table>
				...
				<td class="resultTD" align="center" style="width:300px; background: white;">
					...
					<font size=30   style="color:green;">$189</font> 
					/night
