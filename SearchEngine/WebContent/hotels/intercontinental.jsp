...
<title>Intercontinental at Soho</title>
		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/intercontinental.jpg" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >Intercontinental</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star5.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(Soho) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">Located in the heart of lower Manhattan's Battery Park City, this new, contemporary hotel is adjacent to Hudson River Park and in close proximity to many of New York's important landmarks such as the Statue of Liberty, Wall Street and the New York Stock Exchange, in addition to prominent neighborhoods, including TriBeCa and SoHo. </tr>
					</table>
				...
				<td class="resultTD" align="center" style="width:300px; background: white;">
					...
					<font size=30   style="color:green;">$300</font> 
					/night
