...
<title>Four Points at Manhattan</title>
		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/four points.jpg" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >Four Points</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star4.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(Manhattan) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">This luxury hotel is located in New York (Chelsea), close to Chelsea Market, The High Line Park, and Union Square. Also nearby are Empire State Building and Times Square.</tr>
					</table>
				...
				<td class="resultTD" align="center" style="width:300px; background: white;">
					...
					<font size=30   style="color:green;">$220</font> 
					/night
