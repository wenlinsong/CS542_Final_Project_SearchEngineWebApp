...
<title>Sheraton at Brooklyn</title>
		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/sheraton.jpg" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >Sheraton</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star4.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(Brooklyn) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">Situated in the city center, this hotel is close to Brooklyn Academy of Music, Brooklyn Bridge, and Ellis Island. Area attractions also include Federal Reserve Bank of New York and New York Stock Exchange.</tr>
					</table>
				...
				<td class="resultTD" align="center" style="width:300px; background: white;">
					...
					<font size=30   style="color:green;">$280</font> 
					/night
