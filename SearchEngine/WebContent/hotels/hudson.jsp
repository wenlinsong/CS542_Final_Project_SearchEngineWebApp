...
<title>Hudson at Time Square</title>
		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/hudson.jpg" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >Hudson</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star4.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(Time Squre) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">Located in the heart of New York, this hotel is within walking distance of Broadway, Times Square, and Radio City Music Hall. Also nearby are Rockefeller Center and Grand Central Terminal.</tr>
					</table>
