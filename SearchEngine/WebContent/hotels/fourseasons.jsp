...
<title>Four Seasons at Central Park</title>
		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/four seasons.jpg" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >Four Seasons</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star5.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(Central Park) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">Designed by Philippe Starck, the trendsetting Hudson, A Morgans Original is within a block of the Time Warner Center's shops and restaurants; Central Park is one block away, and five blocks from Lincoln Center.</tr>
					</table>
				...
				<td class="resultTD" align="center" style="width:300px; background: white;">
					...
					<font size=30   style="color:green;">$530</font> 
					/night
