...
<title>Westin at Central Park</title>
		...
		<table class="resultTB" style="font-family: arial;">
			<tr class="resultTR">
				<td class="resultPC" style="height:320px; width:480px; background: blue;">
					...
					<img alt="" src="images/westin.jpg" width = 100% style = "padding:0; margin:0;">
				...
				<td class="resultTD" style="width:400px; background: white;">
					...
					<table width=100% >
						...
						<tr><a class="hotelName" href="#" >Westin</a></tr>
						<br style="line-height: 15px;">
						<tr><img alt="" src="images/star4.png" height=50px style = "padding:0; margin:0;"></tr>
						<br style="line-height: 25px;">
						<tr>New York, NY(Central Park) </tr>
						<br style="line-height: 15px;">
						<tr style="font-size: 15px">The hotel is near Central Park. You can walk to metropolitan museum in 5 minutes.The hotel offers 863 guestrooms in its 45-story glass building and 16-story earth-tone building. These rooms have contemporary décor, premium bedding, wireless internet access, cable/satellite TV.</tr>
					</table>
				...
				<td class="resultTD" align="center" style="width:300px; background: white;">
					...
					<font size=30   style="color:green;">$330</font> 
					/night
